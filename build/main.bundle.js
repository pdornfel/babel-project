...
document.getElementById('calcBtn').addEventListener('click', function () {
    ...
    var _morgage$calculateAmo = morgage.calculateAmortization(principal, years, rate),
        monthlyPayment = _morgage$calculateAmo.monthlyPayment,
        monthlyRate = _morgage$calculateAmo.monthlyRate,
        amortization = _morgage$calculateAmo.amortization;
